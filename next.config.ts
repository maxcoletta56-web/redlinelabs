...
const csp = [
  ...
  "font-src 'self' data:",
  "connect-src 'self' https://assistloop.ai https://vitals.vercel-insights.com https://va.vercel-scripts.com https://api.whop.com https://sandbox-api.whop.com https://js.whop.com https://whop.com https://*.whop.com",
