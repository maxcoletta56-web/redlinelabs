...
| Date | Summary |
| --- | --- |
| 2026-09-25 | Audit written in `#39` and first committed at the repo root. |
| 2026-09-25 | Filed at `reports/catalogue-merchandising-health.md`, which is the path in `reports/project-overview.md`. Image hosts re-checked the same day: 16 PNG responses, 14 HTTP 403s, same slugs as above. |
